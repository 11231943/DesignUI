 ...
 * 跳用动画时
 */
public class SideMenu2 extends HorizontalScrollView {
    ...
    public SideMenu2(Context context, AttributeSet attrs) {
        this(context, attrs, -1);

    }

    public SideMenu2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public SideMenu2(Context context) {
        super(context);
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        float scale = l * 1.0f / mScreenWidth; //1~0

        Log.d("onScrollChanged", "scale = " + scale + "mScreenWidth* scale =" + mScreenWidth * scale);
