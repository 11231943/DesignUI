...
public class FragmentTabHost extends TabHost
    ...
    private boolean mRetainFragmentView;
    ...
    public void setup(Context context, FragmentManager manager, int containerId) {
        setup(context, manager, containerId, true);
    }

    public void setup(Context context, FragmentManager manager, int containerId, boolean retainFragmentView) {
        ensureHierarchy(context);  // Ensure views required by super.setup()
        super.setup();
        mContext = context;
        mFragmentManager = manager;
        ...
        mRetainFragmentView = retainFragmentView;
